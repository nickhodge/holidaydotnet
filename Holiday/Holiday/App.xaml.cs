...
using Holiday.Resources;

namespace Holiday
{
    public partial class App : Application
    {
        private static HolidayDataModel _dataModel = null;
        public static HolidayDataModel DataModel
        {
            get
            {
                // Delay creation of the view model until necessary
                if (_dataModel == null)
                    _dataModel = new HolidayDataModel();
        ...
        public static MainViewModel ViewModel
        {
            get
            {
                // Delay creation of the view model until necessary
                if (viewModel == null)
                    viewModel = new MainViewModel(DataModel);
